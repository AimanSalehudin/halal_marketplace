...
<body class="bg-[#16171B] text-white min-h-screen flex flex-col">
    ...
    <nav class="flex justify-between items-center py-5 px-8 bg-[#16171B] border-b border-white/5">
        ...
        <div class="hidden lg:flex items-center gap-8 text-sm text-gray-300">
            ...
            <a href="#" class="hover:text-white transition-colors">Browse Menu</a>
            <a href="#" class="hover:text-white transition-colors">Restaurants</a>
            <a href="#" class="hover:text-white transition-colors">Track Order</a>
        </div>

        <div class="flex items-center gap-4">
            <button class="p-2 bg-white/5 rounded-full hover:bg-white/10 transition">
                <svg class="w-5 h-5 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
            </button>
            <button class="bg-[#FF7900] hover:bg-orange-600 text-white px-5 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition">
    ...
    <div class="max-w-7xl mx-auto px-8 pt-16 pb-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative">
        ...
        <div>
            ...
            <div class="flex flex-wrap gap-3 mb-12">
                <span class="bg-white/5 border border-white/10 text-gray-300 px-4 py-1.5 rounded-full text-sm hover:bg-white/10 cursor-pointer transition">Halal Burger</span>
                <span class="bg-white/5 border border-white/10 text-gray-300 px-4 py-1.5 rounded-full text-sm hover:bg-white/10 cursor-pointer transition">Biryani</span>
                <span class="bg-white/5 border border-white/10 text-gray-300 px-4 py-1.5 rounded-full text-sm hover:bg-white/10 cursor-pointer transition">Lamb Chops</span>
                <span class="bg-white/5 border border-white/10 text-gray-300 px-4 py-1.5 rounded-full text-sm hover:bg-white/10 cursor-pointer transition">Dates</span>
                <span class="bg-white/5 border border-white/10 text-gray-300 px-4 py-1.5 rounded-full text-sm hover:bg-white/10 cursor-pointer transition">Shawarma</span>
            </div>
        ...
        <div class="grid grid-cols-2 gap-4 h-[500px]">
            ...
            <div class="relative rounded-2xl overflow-hidden group">
                <img src="https://images.unsplash.com/photo-1603048297172-c92544798d5e?auto=format&fit=crop&w=600&q=80" alt="Halal Meat" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                <h3 class="absolute bottom-4 left-4 font-semibold text-lg">Halal Meat</h3>
            </div>
            <div class="relative rounded-2xl overflow-hidden group">
                <img src="https://images.unsplash.com/photo-1583084365738-927b2b62d8ce?auto=format&fit=crop&w=600&q=80" alt="Dates & Fruits" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent"></div>
                <h3 class="absolute bottom-4 left-4 font-semibold text-lg">Dates & Fruits</h3>
            </div>
        </div>
    </div>
