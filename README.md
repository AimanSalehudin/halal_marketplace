...
- Backend Framework: Laravel 12.x with Bagisto E-Commerce Platform
- Frontend: Blade Templates with Bagisto Shop & Admin Themes
- Database: MySQL 8.0
...
> *(To be added — link to ERD document)*

Key Relationships:

- Customers can have multiple Orders (One-to-Many)
- Vendors can have multiple Products (One-to-Many)
- Orders can have multiple Order Items (One-to-Many)
- Products belong to Categories (Many-to-One)
- Customers can have multiple Addresses (One-to-Many)
- Products can have multiple Reviews (One-to-Many)

### Laravel Components Implementation

- Routes (web.php & Bagisto Package Routes)

```php
// Public Routes (Bagisto Shop)
...
- Controllers
  ...
  *Main Controllers Implemented are below :*
  ...
  1. **HomeController**: Handles homepage display and featured product listings
  2. **ProductController**: Manages product browsing, search, and detail display
  3. **CartController**: Manages shopping cart add/remove functionality
  4. **OrderController**: Processes order creation, tracking, and management
  5. **CustomerController**: Customer dashboard, profile, and account management
  6. **VendorController**: Vendor dashboard, storefront, and analytics
  7. **AdminController**: Admin dashboard, user management, and certification approvals

- Models and Relationships

```php
// Customer Model (Bagisto)
...
- Views and User Interface
  ...
  *Blade Templates Structure (Bagisto Themes):*
...
### Challenge 4: Integrating Bagisto with Custom Features
- **Problem**: Extending Bagisto's default e-commerce functionality to support halal-specific features such as certification badges and Shariah-compliant product labels
- **Solution**: Leveraged Bagisto's modular package architecture to build custom modules that integrate seamlessly with the existing platform
...
- **Bagisto E-Commerce Platform**: Working with a production-grade open-source e-commerce framework
...
Local'z successfully demonstrates the implementation of a comprehensive halal food and grocery marketplace using the Laravel framework with the Bagisto e-commerce platform. The project showcases proficiency in web development fundamentals including MVC architecture, database design, role-based user authentication, and responsive web design.
...
- Built upon the Bagisto e-commerce platform to deliver production-grade features including product management, inventory tracking, and order processing
